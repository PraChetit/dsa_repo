...
# modifying the inputs to algorithms tested afterwards.
_TEST_100_ELEM_DATA = [
  ('case_0',
   lambda: [63, 90, 45, 50, 81, 46, 6, 3, 41, 85, 74, 72, 19, 43, 88, 51, 0,
  ...
  ('case_1',
   lambda: [99, 8, 79, 19, 0, 69, 88, 92, 95, 38, 84, 5, 82, 33, 28, 87, 46,
  ...
  ('case_2',
   lambda: [11, 20, 31, 16, 69, 75, 50, 3, 79, 1, 49, 25, 39, 67, 10, 42, 37,
  ...
  ('case_3',
   lambda: [62, 92, 58, 67, 85, 84, 93, 98, 72, 11, 32, 78, 42, 82, 8, 44, 24,
  ...
  ('case_4',
   lambda: [25, 57, 27, 31, 63, 1, 19, 32, 56, 60, 78, 14, 20, 37, 74, 33, 40,
  ...
  ('case_5',
   lambda: [54, 90, 7, 50, 32, 94, 65, 34, 63, 25, 11, 6, 9, 31, 96, 69, 35,
  ...
  ('case_6',
   lambda: [98, 66, 29, 10, 47, 35, 59, 31, 38, 46, 54, 45, 34, 53, 55, 99,
  ...
  ('case_7',
   lambda: [84, 3, 20, 37, 7, 11, 9, 21, 8, 50, 22, 31, 83, 16, 90, 71, 93,
  ...
  ('case_8',
   lambda: [87, 10, 71, 51, 12, 55, 90, 84, 57, 13, 52, 14, 79, 6, 66, 97, 81,
  ...
  ('case_9',
   lambda: [73, 27, 19, 6, 5, 51, 41, 93, 30, 77, 3, 37, 54, 13, 20, 64, 45,
...
class SortingTest(parameterized.TestCase):
  ...
  def test_sorted_array(self, sort_alg):
    ...
    expected_array = list(range(100))
    self._test(sort_alg, input_array, expected_array)

  @parameterized.named_parameters(_SORTING_ALGORITHMS)
  def test_reverse_sorted_array(self, sort_alg):
    reversed_array = list(reversed(range(100)))
    expected_array = list(range(100))
    self._test(sort_alg, reversed_array, expected_array)
